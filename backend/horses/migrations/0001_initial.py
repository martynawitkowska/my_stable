# Generated by Django 4.0.3 on 2022-04-21 12:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stable_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('horse_bit', models.ManyToManyField(related_name='Trainings', to='horses.bitstouse')),
            ],
        ),
        migrations.CreateModel(
            name='Stable',
